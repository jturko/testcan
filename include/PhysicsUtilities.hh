...
namespace Physics 
{
  ...
  double SolidAngle(double* x, double* par);

  double IntegratedSolidAngle(double* x, double* par);

  double BarrelSolidAngle(double* x, double* par);

  double IdentifiedSolidAngle(double* x, double* par);

  double CoveredPhiAngle(double Theta, double DistanceToBeam, double DetectorWidth, double GapWidth, double Shift);

  double CoveredPhiAngle(double* x, double* par);
